...
import { ExecOptionsWithStringEncoding, spawn } from 'child_process'
...
export async function tttool (...args: string[]): Promise<{ stdout: string, stderr: string }>
export async function tttool (opt: Partial<ExecOptionsWithStringEncoding>, ...args: string[]): Promise<{ stdout: string, stderr: string }>
export async function tttool (a: string | Partial<ExecOptionsWithStringEncoding>, ...b: string[]) {
  await init()
  return await execFile(tttoolPath,
