...
export function AppFooter() {
  ...
  return (
    <Flex>
      <Button component='a' variant='subtle' target='_blank' href='http://github.com/lordvlad/totem' leftSection={<Github {...iconStyle} />}>
        {i18n`Check it out on Github`}
      </Button>
      <Button component='a' variant='subtle' target='_blank' href='https://github.com/lordvlad/totem/issues' leftSection={<AlertTriangle {...iconStyle} />}>
        {i18n`File an issue`}
      </Button>
